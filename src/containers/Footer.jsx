...
const Footer = () => {
  return (
    <footer
      data-aos="fade-up"
      className="px-4 w-full flex justify-center border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800/30"
    >
      <div className="w-[1000px] overflow-hidden">
        <div className=" py-8 flex flex-col-reverse md:flex-row justify-between gap-12">
          <div className="flex flex-col items-center md:items-start gap-6 w-full">
            ...
            <div className="text-lg sm:text-xl text-center md:text-start text-gray-500">
            ...
            <ul className="flex gap-6 w-fit">
              <li className="text-gray-500 cursor-pointer hover:text-blue-500">
                Privacy
              </li>
              <li className="text-gray-500 cursor-pointer hover:text-blue-500">
                Terms
        ...
        <div className="text-center h-[75px] flex items-center justify-center px-4 text-gray-500 border-t border-gray-300 dark:border-gray-700">
